    ...
    <>
      <div className=" text-center mb-10">
        ...
        <p className="text-md  text-slate-950 font-medium max-w-lg mx-auto leading-8">
          Welkom! Als HBO-ICT student aan de Haagse Hogeschool ben ik op zoek
          naar een derdejaarsstage bij een bedrijf waar ik mijn eerste stappen
          kan zetten als junior Software Engineer. Hieronder vind je mijn CV en
          kun je ook contact met mij opnemen via LinkedIn of via e-mail.
        </p>
